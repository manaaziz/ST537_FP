...
A visualization of the trees for each hotel can be found below.
...
plot(h1.tree$finalModel)
text(h1.tree$finalModel)
...
# Print out tree visualization
plot(h2.tree$finalModel)
text(h2.tree$finalModel)
```  
